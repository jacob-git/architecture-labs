...
| [SHIELD Lab #001: Independent Evidence Reinforcement](labs/shield_001/) | Can correlation-aware evidence weighting distinguish repeated observations from genuinely independent corroboration? | Phase B broke score v1 and v2 repaired it; Phase C2 broke temporal v1; temporal v2 repaired the frozen regressions; Phase D post-v2 holdout implemented |
